...
export async function POST(request: Request) {
  ...
  const sharedInstructions =
    ...
    `3. この投稿と同じ「型」「構成」「フック(惹きの作り方)」「文体・テンポ」を踏襲しつつ、トピックや具体例は別物にした新しいX投稿を、ちょうど${count}個 generated_posts に作成してください。\n` +
    `   - 元の投稿の文章をそのまま使ったり、単語を少し変えただけの言い換えにすることは禁止です。型を再利用したオリジナルの投稿にしてください。\n` +
